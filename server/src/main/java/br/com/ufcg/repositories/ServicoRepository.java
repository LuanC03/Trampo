...
public interface ServicoRepository extends JpaRepository<Servico, Long> {
	...
	// @Query(value="SELECT * FROM TB_SERVICO s WHERE s.id_cliente=:c_id ORDER BY
	// s.data ASC s.horario ASC", nativeQuery = true)
	...
	Servico findServico(@Param("dt") LocalDate data, @Param("hr") LocalTime hora, @Param("user") Cliente user,
